...
- proof route to inspect before committing more time or budget;
- handoff artifact: tests, logs, docs, runbook, smoke check, deployment note, or support boundary.

## First Slice Options

| First slice | When it fits | What I would ship first | Proof in this repo |
| --- | --- | --- | --- |
